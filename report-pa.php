                        ...
                        <div class="card" style="min-height: 490px">
                            <div class="row justify-content-evenly pt-5">
                                ...
                                <form class="row gy-2 gx-3 justify-content-evenly" method="POST">
                                        <div class="col-md-4">
                                            <?php
                                            $query = "SELECT DISTINCT(apply_for) FROM apply";
                                            $result = $con->query($query);
                                            if ($result->num_rows > 0) {
                                                $apply_for = mysqli_fetch_all($result, MYSQLI_ASSOC);
                                            }


                                            ?>
                                            <label class="" for="autoSizingInput">apply_for</label>
                                            <select class="form-select" id="autoSizingSelect" name="apply_for" require>
                                                <option selected disabled value="">Choose...</option>
                                                <?php
                                                foreach ($apply_for as $apply_for) {
                                                ?>
                                                    <option value="<?php echo $apply_for['apply_for']; ?>"><?php echo $apply_for['apply_for']; ?> </option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                            ...
                                            if (isset($_POST['submit'])) {
                                                $spname = $_POST['apply_for'];
                                            $query = "select * from apply where apply_for = '$spname'";
