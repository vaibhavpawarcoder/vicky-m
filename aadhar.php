...
<body>
    ...
    <!-- navbar_end -->
    <div class="banner-aadhar-image w-100 vh-20 d-flex justify-content-center align-items-center p-5">
        <div class="content text-center p-5">
            <h1 class="text-white p-5 d-none d-lg-block">Aadhar-Card Services</h1>
        </div>
    </div>
    <div class="whats_app">
    ...
    <section id="services" class=" mt-5 mb-5">
        <div class="container mt-5 mb-5">
            <h1 class="text-center mt-5 mb-5">Aadhar-Card Services </h1>
            <p class="text-center mt-5 mb-5">
                You can update your Address online in Self Service Update Portal (SSUP). For other details updates such as Demographic details (Name, Address, DoB, Gender, Mobile Number, Email) as well as Biometrics (Finger Prints, Iris & Photograph) in Aadhaar you will have to visit Permanent Enrolment Center.</p>
                ...
                <div class="col-md-9 ">
                    ...
                    <form class="row g-3" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="add" placeholder="Permaent Address"></textarea>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="tadd" placeholder="temporary Address"></textarea>
                        </div>
                        <div class="col-md-4">
                            <label for="validationDefault05" class="form-label">Country</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="apply" id="validationDefault04" required>
                                ...
                                <option value="Aadhar-Card-Update">Aadhar-Card Update</option>
                            </select>
                        </div>
