...
<body>
    ...
    <div class="banner-pan-image w-100 vh-20 d-flex justify-content-center align-items-center p-5">
        <div class="content text-center p-5">
            <h1 class="text-white p-5 d-none d-lg-block">Pand-Card Services</h1>
        </div>
    </div>
    <div class="whats_app">
    ...
    <section id="services" class=" mt-5 mb-5">
        <div class="container mt-5 mb-5">
            <h1 class="text-center mt-5 mb-5">Pand-Card Services </h1>
                ...
                <div class="col-md-9 ">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if (in_array($filechk, $fileextstore)) {
                            ...
                            $destinationss = 'admin/Upload/' . $filename;
                            move_uploaded_file($filetemp, $destinationss);
