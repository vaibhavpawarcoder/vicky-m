...
<body>
    ...
    <div  class="banner-pan-image w-100 vh-20 d-flex justify-content-center align-items-center p-5">
        <div class="content text-center p-5">
          <h1 class="text-white p-5 d-none d-lg-block">Pand-Card & Aadhar-Card Update Services</h1>
       </div>
      </div>
      <div class="whats_app">
...
<br><br><br>
    ...
    <section id="services" class=" mt-5 mb-5">
        <div class="container mt-5 mb-5">
            <h1 class="text-center mt-5 mb-5" >Pan-Card And Aadhar-Card Update Services </h1>
