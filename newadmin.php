                        ...
                        <div class="card" style="min-height: 490px">
                            <div class="row justify-content-evenly">
                                ...
                                ?>
                                            ...
                                            $insertquery = "INSERT INTO `admin`( First_Name, Last_Name, Mobile, Email, Password, City, State, District,Zip,Profile) 
        VALUES ('$First_name','$Last_name','$Mobile','$Email','$Password_safe','$City','$State','$District','$Zip','$destination')";
